      ...
      <div className="fixed inset-0 z-0">
        ...
        {bokeh.map((p) => (
          <motion.div
            ...
            className="absolute rounded-full bg-red-500/10 blur-3xl pointer-events-none"
      ...
      <main className="relative z-10 container mx-auto px-4 py-12 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-7xl w-full mb-24">
          ...
          <motion.div 
            ...
            whileHover={{ y: -5 }}
            viewport={{ once: true }}
            className="md:col-span-8 bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 md:p-16 flex flex-col items-center text-center relative overflow-hidden group shadow-2xl transition-all duration-500 hover:bg-white/[0.05]"
          >
            <motion.div 
